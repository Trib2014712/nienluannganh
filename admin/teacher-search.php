...
if (isset($_SESSION['admin_id']) && isset($_SESSION['role'])) {
    if ($_SESSION['role'] == 'Admin') {
        // Kiểm tra xem biến 'searchKey' đã được truyền trong URL không
...
<body>
    <?php 
     ...
     <div class="container mt-5">
        <a href="teacher-add.php" class="btn btn-dark">Thêm giáo viên mới</a>
              ...
              <table class="table table-bordered mt-3 n-table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="teacher-edit.php?teacher_id=<?=$teacher['teacher_id']?>" class="btn btn-warning">Chỉnh sửa</a>
                        <!-- <a href="teacher-delete.php?teacher_id=<?=$teacher['teacher_id']?>" class="btn btn-danger">Xóa</a> -->
                    </td>
                  </tr>
                <?php } ?>
                </tbody>
