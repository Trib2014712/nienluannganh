...
if (isset($_SESSION['teacher_id']) && 
    ...
    include "function/class.php"; // Đổi tên biến này thành class_name hoặc một tên khác không trùng với từ khóa của PHP
    include "function/section.php";
    include "function/setting.php";
    include "function/subject.php";
    include "function/teacher.php";
    include "function/student_score.php"; 
...
<body>
    ...
    <div class="d-flex align-items-center flex-column"><br><br>
        <div class="login shadow p-3">
            <form method="post" action="">
                <div class="mb-3">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><b>Tên: </b> <?php echo $student['fname'] ?></li>
                        <li class="list-group-item"><b>Họ: </b> <?php echo $student['lname'] ?></li>
                        ...
                        <li class="list-group-item"><b>Phần: </b> 
                            <?php  
                                $s = getSectioById($student['section'], $conn); 
                                echo $s['section'];
                            ?>
                        </li>
                        <li class="list-group-item text-center"><b>Năm học: </b> <?php echo $setting['current_year']; ?> &nbsp;&nbsp;&nbsp;<b>Học kỳ</b> <?php echo $setting['current_semester']; ?></li>
                    </ul>
                </div>
            ...
            <!-- Đoạn mã này được sử dụng để hiển thị các ô nhập điểm cho học sinh trong form. -->
                <?php 
                    if ($ssubject_id != 0) { 
                        $counter = 0;
                        if($student_score != 0){ ?>
                        ...
                        <?php } } if($counter <  1){ 
                            for ($i=++$counter; $i <= 1 ; $i++) { 
                        ?>
                        <!-- $counter nhỏ hơn 1 (tức là không có điểm nào được lưu trữ), một vòng lặp for được sử dụng để tạo ra một ô nhập điểm. -->
                            <div class="input-group mb-3">
